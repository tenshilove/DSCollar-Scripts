...
/|*
This script needs to handle anim requests from sister scripts as well. It has essentially two layers
...
UserCommand(integer iNum, string sStr, key kID) {
    ...
    } else if (sStr == "relax" || sStr == "stand") {  /|/only release if person giving command outranks person who posed us
...
//last_compiled 05/09/2017 11:27:43
//mono
